    ...
    <>
      <div className={`offcanvas offcanvas-start right-side-vorix-offcanvas shadow-lg ${openCanvas ? 'show' : ''}`} tabIndex={-1} id="sideMenuOffcanvas">
        ...
        <div className="offcanvas-header">
          <div>
            <img className={`${styles.offcanvasLogo} dark-logo`} src="/assets/img/core-img/pf-logo5.png" alt="Profech Logo" />
            <img className={`${styles.offcanvasLogo} light-logo`} src="/assets/img/core-img/pf-all-yellow.png" alt="Profech Logo" />
          </div>
        ...
        <div className="offcanvas-body">
          ...
          <p>Ready to take the first step towards unlocking opportunities and realizing your goals.</p>
          ...
          <div className="contact-info">
            ...
            <div>
              ...
              <div>
                <p>Phone number</p>
                <h5 className="mb-0">+234 903 903 0524</h5>
              </div>
            </div>
            ...
            <div>
              ...
              <div>
                <p>Email address</p>
                <h5 className="mb-0">admin@profech.com</h5>
              </div>
            </div>
            ...
            <div>
              ...
              <div>
                <p>Office Address</p>
                <h5 className="mb-0">Lagos, Nigeria</h5>
              </div>
            </div>
          </div>
          ...
          <div className="social-nav">
            ...
            <a href="https://x.com/profech_it" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://linkedin.com/company/profech-it" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://instagram.com/profech_it" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
          ...
          <div className="cta-btn">
            <Link to="/contact">Talk <br /> with us</Link>
          </div>
        </div>
      </div>
    </>
