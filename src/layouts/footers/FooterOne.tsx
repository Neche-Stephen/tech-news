          ...
          <div className="row g-5">
            ...
            <div className="col-12 col-md-6 col-xl">
              <div className="footer-card">
                ...
                <a href="/">
                  <img className={`${styles.footerLogo} dark-logo`} src="/assets/img/core-img/pf-logo5.png" alt="Profech Logo" />
            ...
            <div className="col-12 col-md-6 col-xl">
              <div className="footer-card">
                ...
                <ul className="footer-nav">
                  ...
                  <li><a href="#">Portfolio & Personal Websites</a></li> */}
        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-12 col-lg-6">
              <p className="mb-0 copyright">Copyright © {new Date().getFullYear()} <span id="year"></span> <a href="#"> Profech IT Services</a></p>
            </div>
